...
def parse_example(serialized_example):
    ...
    return x, x                      # auto-encoder ⇒ (input, label)
...
def build_model():
    ...
    x = tf.keras.layers.Conv3D(1, 3, padding="same",
                               kernel_initializer="he_normal")(x)
    out = tf.keras.activations.tanh(x)          # outputs in [-1,1]
...
#train_ds = get_dataset("/home/leonardo/SAXS_reconstruction/changed_network/train_net/dataset/PISA_aligned/train.tfrecords,BATCH_SIZE")
#test_ds = get_dataset("/home/leonardo/SAXS_reconstruction/changed_network/train_net/dataset/PISA_aligned/test.tfrecords,BATCH_SIZE")
